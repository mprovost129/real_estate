...
ONE_TIME_BROADCAST_MAX_RECIPIENTS = env.int('ONE_TIME_BROADCAST_MAX_RECIPIENTS', default=300)
BROADCAST_REQUIRE_SECOND_APPROVER = env.bool('BROADCAST_REQUIRE_SECOND_APPROVER', default=True)
BROADCAST_QUIET_HOURS_ENABLED = env.bool('BROADCAST_QUIET_HOURS_ENABLED', default=True)
BROADCAST_QUIET_HOURS_START = env.int('BROADCAST_QUIET_HOURS_START', default=21)
BROADCAST_QUIET_HOURS_END = env.int('BROADCAST_QUIET_HOURS_END', default=8)
BROADCAST_REQUIRE_LEGAL_FOOTER = env.bool('BROADCAST_REQUIRE_LEGAL_FOOTER', default=True)
BROADCAST_EMAIL_LEGAL_FOOTER = env(
    'BROADCAST_EMAIL_LEGAL_FOOTER',
    default='You are receiving this message because you previously opted in. Reply or contact us to unsubscribe.',
)
BROADCAST_SMS_LEGAL_FOOTER = env(
    'BROADCAST_SMS_LEGAL_FOOTER',
